...
import { hacker } from "../public/assets";
...
const Banner = () => {
  ...
  return (
    <div className="max-w-contentContainer mx-auto flex items-center justify-between">
      <section
        id="home"
        className="py-10 mdl:py-24 flex flex-col gap-4 lgl:gap-8 mdl:px-10 xl:px-4"
      >
        <motion.h3
        ...
        >
          ...
          finance and education to product management and design, I have a
          diverse background in creating innovative solutions. With expertise in
          technologies such as JavaScript, TypeScript, React, and Node.js,
          I&apos;m passionate about using technology to simplify and enhance
          daily life. Explore my portfolio to see examples of my work and how I
          bring creativity and functionality to every project. <br />
          {/* <Link href="/">
      ...
      <Image
        className="hidden mdl:block w-[400px] h-full object-contain"
        src={hacker}
        alt="femgpt"
      />
    </div>
