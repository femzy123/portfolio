...
export function IconPanel({
  ...
  return (
    <article
      className={cn(
        "rounded-[1.6rem] border border-slate-900/8 bg-white/62 p-5 shadow-[0_18px_55px_rgba(15,23,42,0.08)] backdrop-blur-xl dark:border-white/10 dark:bg-white/[0.045] dark:shadow-[0_18px_70px_rgba(0,0,0,0.18)]",
        className
      )}
    >
